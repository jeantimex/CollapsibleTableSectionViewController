#
#  Be sure to run `pod spec lint CollapsibleTableSectionViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "jeantimex"
  # s.authors            = { "jeantimex" => "jean.timex@gmail.com" }
  # s.social_media_url   = "http://twitter.com/jeantimex"
